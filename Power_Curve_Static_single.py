...
color_map = {'red':'#ff0000FF', 'green' : '#048F04FF', 'blue' : '#0404FFFF', 'grey' : '#a5a5a5AF', 'orange' : '#ed7d31FF' }
line_size = 3
...
if PowerCurve:
    ...
    ax2.set_yticks(range(190, 220, 5), minor=True)
    ...
    ax4.set_ylim(0, 40);     ax4.set_yticks(range(00, 40, 5), minor=True)
